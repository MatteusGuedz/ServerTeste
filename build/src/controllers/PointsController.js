...
var PointsController = /** @class */ (function () {
    ...
    PointsController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, whatsapp, latitude, longitude, uf, city, items, trx, point, insertIds, point_id, pointItems;
    ...
    PointsController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, items, uf, city, parserItems, points, serializedPoints;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.query, items = _a.items, uf = _a.uf, city = _a.city;
                        parserItems = String(items)
                            .split(',')
                            .map(function (item) { return Number(item.trim()); });
